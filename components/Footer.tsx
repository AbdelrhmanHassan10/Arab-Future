...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/arab-future-ltd/",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Pinterest",
    href: "https://www.pinterest.com/arabfuture13/",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="bg-navy-deeper">
      {/* Main footer */}
      <div className="pad-x container-wide py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          {[
            ...
            <div key={i} className="lg:col-span-2">
              <h4 className="text-micro text-white/45 uppercase tracking-widest mb-6">
                {group.title}
              </h4>
              <ul className="space-y-3">
                {group.links.map((link, j) => (
                  <li key={j}>
                    <a
                      href={link.href}
                      className="text-white/55 text-[13px] hover:text-primary transition-colors duration-500"
                    >
                      {link.label}
                    </a>
                  </li>
      ...
      <div className="border-t border-white/[0.06]">
        <div className="pad-x container-wide py-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/terms" className="text-white text-[11px] hover:text-primary transition-colors duration-400">الشروط والأحكام</a>
          </div>
        </div>
      </div>
    </footer>
