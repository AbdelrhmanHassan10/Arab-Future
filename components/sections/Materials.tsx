...
const materials = [
  ...
  },
  {
    ...
    description: "مجموعة متميزة من أكواد العقاريه التجارية والسكنية الجاهزة للبناء في أرقى المناطق.",
      ...
      <div className="container-wide px-6 relative z-10">
        ...
        >
          ...
          <p className="text-white/50 text-base mt-4 font-light">
            نوفر في أكواد العقاريه العقاريه خيارات عقارية شاملة تناسب السكن الفاخر، الاستثمار التجاري، أو قضاء أوقات ممتعة في المنتجعات الساحلية.
          </p>
        </motion.div>
