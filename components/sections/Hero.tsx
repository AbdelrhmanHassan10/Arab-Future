...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Floating Orbs */}
      <div className="absolute top-[20%] right-[20%] w-[300px] h-[300px] bg-primary/20 rounded-full blur-[120px] mix-blend-screen pointer-events-none animate-pulse-slow" />
      <div className="absolute bottom-[20%] left-[20%] w-[400px] h-[400px] bg-[#CBA365]/10 rounded-full blur-[150px] mix-blend-screen pointer-events-none animate-float" />
      ...
      >
        ...
        <div className="relative mb-6 w-full max-w-5xl mx-auto">
          ...
          >
            اكتشف منزل أحلامك مع <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#DFBA7F] via-primary to-[#A07B40]">
              أفضل مستشار عقاري
            </span>
          </motion.h1>
        </div>
        ...
        >
          نوفر لك أفضل الفرص العقارية في مصر، من فلل وشقق فاخرة إلى عقارات تجارية متميزة، مع خبرة تمتد لسنوات في السوق العقاري لضمان أفضل استثمار لك ولعائلتك.
        </motion.p>
        ...
        >
          <Link href="/projects" className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-primary text-navy-deeper font-bold rounded-full overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-[0_0_30px_rgba(191,154,95,0.4)]">
            <span className="relative z-10 text-[15px]">ابحث عن عقارك</span>
