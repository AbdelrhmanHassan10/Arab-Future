      ...
      {show && (
        ...
        >
          ...
          <a href={consultationUrl} target="_blank" rel="noopener noreferrer" className="group relative flex items-center gap-2">
            ...
            <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300">
          ...
          <a href={inspectionUrl} target="_blank" rel="noopener noreferrer" className="group relative flex items-center gap-2">
            ...
            <div className="w-12 h-12 bg-primary-dark rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300">
          ...
          <a href={telUrl} className="group relative">
            <div className="w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-lg shadow-primary/30 hover:shadow-xl hover:scale-110 transition-all duration-300">
              <svg className="w-6 h-6 text-navy-deeper" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
