...
const contactInfo = [
  ...
  },
  {
    ...
    labelEn: "Email",
    value: "info@semsar-masr.com",
    link: "mailto:info@semsar-masr.com",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    value: "شارع التسعين الشمالي، التجمع الخامس، القاهرة",
    link: null,
  },
  {
    icon: (
                ...
                {!isMounted ? null : (
                  ...
                  >
                    ...
                    <p className="text-white/50 text-sm font-medium mb-10">
                      املأ النموذج أدناه وسيقوم أحد خبرائنا العقاريين بالتواصل معك خلال ساعة واحدة.
                    </p>
