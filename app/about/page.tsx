  ...
  return (
    <main className="min-h-screen bg-[#090909] font-body selection:bg-primary/30 selection:text-white overflow-hidden">
      ...
      <section className="py-24 relative bg-white">
        ...
        <div className="container-wide px-6 relative z-10 pt-16">
          <SectionHeader subtitle="Our Experts" title="فريق الخبراء" darkText={true} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {team.map((member, i) => (
              <motion.div 
                ...
                className="relative group rounded-[2.5rem] overflow-hidden aspect-[3/4] border border-gray-100 shadow-soft"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 text-center">
                  <h4 className="text-2xl font-bold text-navy-dark mb-2 group-hover:text-primary transition-colors">{member.name}</h4>
                  <p className="text-primary-dark text-sm font-bold tracking-widest">{member.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 relative overflow-hidden bg-[#090909]">
        ...
        <div className="container-wide px-6 relative z-10 pt-16">
          <div className="max-w-6xl mx-auto bg-[#1a1a1a] rounded-[3rem] border border-white/5 overflow-hidden flex flex-col lg:flex-row shadow-[0_0_40px_rgba(191,154,95,0.03)]">
            ...
            <div className="lg:w-2/5 relative min-h-[400px] lg:min-h-[500px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1a1a1a] via-[#1a1a1a]/40 to-transparent lg:bg-gradient-to-r" />
            </div>
            ...
            <div className="lg:w-3/5 p-10 md:p-16 flex flex-col justify-center relative">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#111111] border border-white/10 mb-6">
